    ...
    <section id="model" className="relative w-full bg-black text-white border-t border-white/10">
      <div className="mx-auto max-w-7xl px-6 py-20 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div data-reveal>
          ...
          <div className="mt-8 flex gap-3" data-reveal data-reveal-delay="120">
        ...
        <div className="relative w-full aspect-[4/3] rounded-2xl overflow-hidden ring-1 ring-white/10 bg-gradient-to-b from-zinc-900 to-black" data-reveal data-reveal-delay="180">
